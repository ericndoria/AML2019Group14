...
![alt text](Images/differential_wrt_x_1.gif)

![alt text](Images/differential_wrt_x_2.gif)

Plotting the function produces the following graphical illustration:

![alt text](Images/f(x_1,x_2)_graph.png)
...
![alt text](Images/GD_graph_pv.png)
...
![alt text](Images/GD_graph_path.png)
...
![alt text](Images/GD_graph_path_momentum.png)
...
![alt text](Images/GD_graph_path_NAG.png)
